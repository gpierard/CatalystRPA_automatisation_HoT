...
Also fully Open-source and multi-platform.
Its natively supports the Selenium library which allows the creation of web broser automation bots.
...
::: {.callout-tip}
[stackoverflow.com](stackoverflow.com) is very helpful 
:::

- Part 1: Calculate the mean price of vehicles with at least 6 cylinders.
- Part 2: Calculate the mean price of vehicles with at least 6 cylinders and 200HP.
...
df <- read.xlsx(r"{G:\Shared drives\CatalystRPA\Clients\Technifutur\Cours 09-2021\Exercices\Exercice 4\cars.xlsx}")
...
#### Resolution draft in python

Using pandas, we can perform the same kind of operations.
...
# Combining tools via functions and languages
