...
Let's dive into a Selenium example and see how it actually works. Head to [Selenium - Getting Started](https://www.selenium.dev/documentation/webdriver/getting_started/) and install the python library.
