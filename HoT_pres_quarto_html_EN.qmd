...
- Part2: Calculate the mean price of vehicles with at least 6 cylinders and 200HP.
...
setwd(r"{G:\Shared drives\CatalystRPA\Clients\Technifutur\Cours 09-2021\Exercices\Exercice 4}")

library(openxlsx) # install.packages("openxlsx")
library(assertthat) # install.packages("assertthat")
df <- read.xlsx("cars.xlsx")
...
# Combining functions and languages
